...
import { invoiceItems } from "../../utils/utils";
      ...
      {fields.map((i, index) => {
        return (
          <div className="space-y-3" key={i.id}>
            <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-end my-4 bg-gray-50 p-3 rounded-lg">
